                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-center">Request persons
                                        <a href="{{ 'request-history' }}" class="btn btn-warning float-end">Request History</a>
                                        <a href="{{ 'admin.orders' }}" class="btn btn-warning float-start"> New Orders </a>
                                    </h4>
                                    <p class="card-description text-center">
                                        The orders <code>Requets align</code>
                                    </p>
