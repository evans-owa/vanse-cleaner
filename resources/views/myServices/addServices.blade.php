                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Addding services staff</h4>
                                ...
                                @endif
                                    <form class="forms-sample" action="serviceadd" method="POST">

                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Service id</label>
                                            <input type="numebr" class="form-control" id="exampleInputEmail3"
                                                placeholder="serviceid" name="serviceid" value="{{old('serviceid')}}">
                                            <span style="color:red">@error('serviceid'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Service Name</label>
                                            <input type="text" class="form-control" id="exampleInputName1" name="service"
                                                placeholder="Service name" value="{{old('service')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1" name="Description"
                                                ...
                                                <span style="color:green">@error('Description'){{$message}} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Category</label>
                                            <select class="form-control" id="exampleInputName1" name="Category"value="{{old('special')}}">
