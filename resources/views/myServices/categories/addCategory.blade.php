                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Addding categories</h4>
                                ...
                                @endif
                                    <form class="forms-sample" action="categoryadd" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Areas</label>
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    name="Areas" placeholder="Areas"
                                                    value="{{ old('') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    name="metatitle" placeholder="metatitle"
                                                    value="{{ old('metatitle') }}">
                                                <span style="color:green">
                                                    @error('metatitle')
                                                        {{ $message }}
                                            ...
                                            <tbody>
                                                @foreach ($category as $item)
                                                   <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('edit-catgry'.$item->id )}}" class="btn btn-primary">Edit</a>
                                                            <a href="{{url('deletecategory'.$item->id)}}" class="btn btn-danger">delete </a>
                                                        </td>
                                                       {{--<td>{{ $gencys['customer_id'] }}</td>--}}
                                                {{--<td>{{ $gencys['email'] }}</td>--}}
                                                       {{-- <td>{{ $gencys['location'] }}</td>--}}
                                                        {{--<td>{{ $gencys['service needed'] }}</td>--}}
                                                    </tr>
                                                    @endforeach
                                                  </tbody>
                                        </table>
