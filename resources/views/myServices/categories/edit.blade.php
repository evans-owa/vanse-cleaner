                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="forms-sample" action="{{url('categoryupdate'.$category->id)}}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Category</label>
                                            <select class="form-control" id="exampleInputName1" name="name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" {{ $category->status == '1' ? 'checked' : '' }}
                                                    id="exampleInputName1" name="Status" placeholder="Status">
                                            </div>
                                            @if ($category->image)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    name="metatitle" value="{{ $category->meta_title }}"
