                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            ...
                            <form class="forms-sample" action="{{url('staffupdate'.$staff->id)}}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Staff id</label>
                                            <input type="numebr" class="form-control" id="exampleInputEmail3" name="id"
                                                placeholder="staff id" value="{{$staff->staffid}}">
                                                <span style="color:red">@error('id'){{$message}} @enderror </span>
                                        </div>
                                        @if ($staff->image)
                                        <img src="{{ asset('assets/uploads/staffs/' . $staff->image) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="image" id="exampleInputName1"
                                                placeholder="Profile" value="{{$staff->image}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleSelectGender" name="service_name"value="{{$staff->service_name}}">
                                                <option>{{$staff->service_name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleSelectGender" name="gender" value="{{$staff->gender}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="exampleInputCity1"
                                                placeholder="Amount" name="Salary" value="{{$staff->Salary}}">
